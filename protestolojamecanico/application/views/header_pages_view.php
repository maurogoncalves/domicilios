...
<html lang="en">
    <head>
		...
		<link href="<?php echo $this->config->base_url(); ?>assets/css/select.css" type="text/css" rel="stylesheet">		-->				<link href="<?php echo $this->config->base_url(); ?>assets/css/select2.min.css" type="text/css" rel="stylesheet">		
    ...
    <body>
        ...
        <section class="page">
             ...
             <?php 			if($_SESSION['login_walmart']['primeiro_acesso'] == 1){				include('sidebar.php');			}			?>
