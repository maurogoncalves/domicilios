...
class Protesto extends CI_Controller {
 ...
 function cadastrar_protesto(){
	...
	foreach($emails as $valor){
		...
		<BR>
		<a href="https://bdwebgestora.com.br/domicilios/smartfit/index.php/protesto/tracking?id='.$id.'" target="_blank" >https://bdwebgestora.com.br/domicilios/smartfit/</a>
		<BR><BR>
...
function encaminhar(){
	...
	$this->email->to($list);
		...
		Acesse o link abaixo para acessar o sistema.
		<BR>
		<a href="https://bdwebgestora.com.br/domicilios/smartfit/index.php/protesto/tracking?id='.$idProtesto.'" target="_blank" >https://bdwebgestora.com.br/domicilios/smartfit/</a>
		<BR><BR>
 ...
 function verDadosProtesto(){
	...
	function arquivosApp(){	
		...
		for($i=0;$i<=4;$i++){
			...
			if (file_exists($filename)) {
				$urlArr[$i]['url'] = 'https://bdwebgestora.com.br/domicilios/smartfit/arquivos/protesto/'.$id.'-'.$i.'.pdf';				
			}else{
				$urlArr[$i]['url'] = '-';
			}
		}	
