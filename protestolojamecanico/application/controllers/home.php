...
class Home extends CI_Controller {
 ...
 function conclusao_infracao_notificacao(){	
	...
	if(!empty($dataConclusao)){
		$dataConclusaoArr = explode('/',$dataConclusao);
		$data = $dataConclusaoArr[2].'-'.$dataConclusaoArr[1].'-'.$dataConclusaoArr[0];
	}else{		
		$data = '1900-01-01';
	}	
 ...
 function lista(){	
	...
	if(!empty($dadosNotificacao)){
		...
		$retornoNot .="<tr style='font-weight:bold!important'>
			<td style='text-align:center;width:7%;border:1px solid #002060;'>Cnpj Raiz</td>
			<td style='text-align:center;width:7%;border:1px solid #002060;'>Cnpj</td>
			<td style='text-align:center;width:10%;border:1px solid #002060;'>I.E.</td>
			<td style='text-align:center;width:10%;border:1px solid #002060;'>I.E. ST</td>
			<td style='text-align:center;width:10%;border:1px solid #002060;'>I. Mob.</td>
			<td style='text-align:center;width:10%;border:1px solid #002060;'>Competência Legislativa</td>
			...
			<td style='text-align:center;width:12%;border:1px solid #002060;'>Tracking</td>
			<td style='text-align:center;width:12%;border:1px solid #002060;'>Concluir </td>
			</tr>";
		foreach($dadosNotificacao as $dados){
			...
			if($data_ciencia_br == '01/01/1900'){
				$data_ciencia_br='';
			}
			if($prazo_br == '01/01/1900'){
				$prazo_br='';
			}
			...
			<td style='padding-left:4px;border:1px solid #002060;width:5%;'>$num_st </td>
			<td style='padding-left:4px;border:1px solid #002060;width:5%;'>$num_im </td>
			<td style='padding-left:4px;border:1px solid #002060;width:7%;'>$competencia</td>
			<td style='padding-left:4px;border:1px solid #002060;width:5%;'>$data_ciencia_br</td>			
			<td style='padding-left:4px;border:1px solid #002060;width:5%;'>$prazo_br</td>
			<td style='padding-left:4px;border:1px solid #002060;width:30%;'>$relato_infracao</td>
			<td style='padding-left:4px;border:1px solid #002060;width:8%;'><a target='_blank' title='Tracking' href='$base/notificacao/tracking?id=$id' class='btn'> <i title='Tracking' class='fa fa-cogs'></i></a></td>
			<td style='padding-left:4px;border:1px solid #002060;width:10%;'> <a  title='Concluir' href='#' id='$id-1' class='btn concluir'> <i title='Concluir' id='$id-1' class='fa fa-lock concluir'></i></a>  </td>
			</tr>";
	...
	if(!empty($dadosInfracao)){
		...
		foreach($dadosInfracao as $dados){
			...
			<td style='padding-left:4px;border:1px solid #002060;width:5%;'>$num_st </td>
			<td style='padding-left:4px;border:1px solid #002060;width:5%;'>$num_im </td>
			<td style='padding-left:4px;border:1px solid #002060;width:18%;'>$competencia</td>
			...
			<td style='padding-left:4px;border:1px solid #002060;width:30%;'>$relato_infracao</td>
			<td style='padding-left:4px;border:1px solid #002060;width:8%;'><a target='_blank' title='Tracking' href='$base/notificacao/tracking?id=$id' class='btn'> <i title='Tracking' class='fa fa-cogs'></i></a></td>
			<td style='padding-left:4px;border:1px solid #002060;width:10%;'> <a  title='Concluir' href='#' id='$id-2' class='btn concluir'> <i title='Concluir' id='$id-2' class='fa fa-lock concluir'></i></a>  </td>
			</tr>";
	...
	if(!empty($dadosProtesto)){
		...
		$retornoProtesto .="<tr style='font-weight:bold!important'>			
			...
			<td style='text-align:center;width:5%;border:1px solid #002060;'>I.E. ST</td>
