 ...
 function lista(){	
	...
	if(!empty($dadosNotificacao)){
		...
		foreach($dadosNotificacao as $dados){
			...
			<td style='padding-left:4px;border:1px solid #002060;width:8%;'>
			<a target='_blank' title='Tracking' href='$base/notificacao/tracking?id=$id' class='btn'> <i title='Tracking' class='fa fa-cogs'></i></a>
			<a target='_blank' title='Editar' href='$base/notificacao/editar?id=$id' class='btn'> <i title='Editar' class='fa fa-pencil'></i></a>
			</td></tr>";
	...
	if(!empty($dadosInfracao)){
		...
		foreach($dadosInfracao as $dados){
			...
			<td style='padding-left:4px;border:1px solid #002060;width:30%;'>$relato_infracao</td>
			<td style='padding-left:4px;border:1px solid #002060;width:8%;'>
			<a target='_blank' title='Tracking' href='$base/infracoes/tracking?id=$id' class='btn'> <i title='Tracking' class='fa fa-cogs'></i></a>
			<a target='_blank' title='Editar' href='$base/infracoes/editar?id=$id' class='btn'> <i title='Editar' class='fa fa-pencil'></i></a>
			</td></tr>";
